...
public class WebServiceResultReceiver extends ResultReceiver {
    //public static final String DATABASE = "com.example.geolocal.receiver.type.DATABASE";
    public static final String WEBSERVICE = "com.example.geolocal.receiver.type.WEBSERVICE";
