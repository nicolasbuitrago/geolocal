 ...
 * helper methods.
 */
public class SocketManagementService extends IntentService implements IClientSocketManagerCaller, IBroadcastManagerCaller {

    ClientSocketManager clientSocketManager;
    BroadcastManager broadcastManager;
    public static String SOCKET_SERVICE_CHANNEL="com.example.geolocal.SOCKET_SERVICE_CHANNEL";
    ...
    public static final String ACTION_CONNECT = "com.example.geolocal.network.action.ACTION_CONNECT";
    private static final String ACTION_BAZ = "com.example.geolocal.network.action.BAZ";
